    ...
    <div style={{ display: 'flex', flexDirection:'column', padding: 75, paddingLeft: 125 }}>
      ...
      >
        <div style={{ display: 'flex', flex: 2, flexDirection:'column', justifyContent:'left', color: fontColor}}>
          ...
          <p>
            {text.body1}
            <a href="https://www.replicant.ai/" target="_blank" rel="noreferrer">
              @Replicant
            </a>
            {text.body1_1}
          </p>
          ...
          <div style={{ display: 'flex', flexDirection:'row', justifyContent:'left', color: fontColor, marginTop: 28 }}>
            <span className = 'svg-color color-fade' onClick={() => window.open('mailto:kenneth.cui296@gmail.com')} style = {{ cursor: 'pointer', marginRight: 15 }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 12.713l-11.985-9.713h23.971l-11.986 9.713zm-5.425-1.822l-6.575-5.329v12.501l6.575-7.172zm10.85 0l6.575 7.172v-12.501l-6.575 5.329zm-1.557 1.261l-3.868 3.135-3.868-3.135-8.11 8.848h23.956l-8.11-8.848z"/></svg>
            </span>
            <span className = 'svg-color color-fade' onClick={() => window.open('https://github.com/k5cui')} style = {{ cursor: 'pointer', marginRight: 15 }}>
            ...
            <span className = 'svg-color color-fade' onClick={() => window.open('https://www.linkedin.com/in/kenneth-cui11/')} style = {{ cursor: 'pointer' }}>
